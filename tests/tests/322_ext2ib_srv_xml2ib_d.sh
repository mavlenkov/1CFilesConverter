...
TEST_NAME="Ext XML -> load to server infobase (designer)"
TEST_OUT_PATH="${OUT_PATH}/$(basename "${BASH_SOURCE[0]}" .sh)"
TEST_OUT_PATH="${TEST_OUT_PATH// /_}"
TEST_CHECK_PATH="${TEST_OUT_PATH}/DataProcessors/Расш1_Обработка2.xml"
...
"${SCRIPTS_PATH}/conf2ib.sh" "${TEST_XML_CF}" "/S${V8_SRV_ADDR}:${V8_SRV_REG_PORT}/${TMP_IB_NAME}"
