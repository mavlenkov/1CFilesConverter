...
TEST_NAME="Ext CFE -> load to server infobase (ibcmd)"
...
"${SCRIPTS_PATH}/conf2ib.sh" "${TEST_BINARY}/1cv8.cf" "/S${V8_DB_SRV_ADDR}/${TMP_IB_NAME}"

"${SCRIPTS_PATH}/ext2ib.sh" "${TEST_BINARY}/Расширение1.cfe" "/S${V8_DB_SRV_ADDR}/${TMP_IB_NAME}" "Расширение1"

"${SCRIPTS_PATH}/ext2xml.sh" "/S${V8_DB_SRV_ADDR}/${TMP_IB_NAME}" "${TEST_OUT_PATH}" "Расширение1"
