...
Серверные тесты SHALL использовать Linux-эквиваленты Windows-инструментов: psql вместо sqlcmd, pgrep/kill вместо tasklist/taskkill, Linux-пути для RAC/RAS.
